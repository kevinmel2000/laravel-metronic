<div class="cbp-loadMore-block1">
    <div class="graphic web-design cbp-item">
        ...
        <div class="cbp-l-grid-projects-title uppercase text-center">Shopping Gallery</div>
    ...
    <div class="graphic logos cbp-item">
        ...
        <div class="cbp-l-grid-projects-title uppercase text-center">Timezone Mgmt</div>
        <div class="cbp-l-grid-projects-desc uppercase text-center">Graphic / Logo</div>
    </div>
    <div class="graphic logos cbp-item">
        <div class="cbp-caption">
        ...
        <div class="cbp-l-grid-projects-title uppercase text-center">Story Book</div>
        <div class="cbp-l-grid-projects-desc uppercase text-center">Graphic / Logo</div>
    </div>
    <div class="identity web-design cbp-item">
        ...
        <div class="cbp-l-grid-projects-title uppercase text-center">Website Lightbox</div>
        <div class="cbp-l-grid-projects-desc uppercase text-center">Identity</div>
    </div>
</div>
<div class="cbp-loadMore-block2">
    <div class="graphic web-design cbp-item">
        ...
        <div class="cbp-l-grid-projects-title uppercase text-center">Mountaineer</div>
        <div class="cbp-l-grid-projects-desc uppercase text-center">Graphic / Logo</div>
    </div>
    <div class="identity logos cbp-item">
        ...
        <div class="cbp-l-grid-projects-title uppercase text-center">Archiview</div>
        <div class="cbp-l-grid-projects-desc uppercase text-center">Graphic / Logo</div>
    </div>
</div>
