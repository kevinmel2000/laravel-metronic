<div class="cbp-loadMore-block1">
    <div class="cbp-item identity">
        <a href="{{ asset('assets/global/img/portfolio/1200x900/08.jpg') }}" class="cbp-caption cbp-lightbox" data-title="Remind~Me More<br>by Tiberiu Neamu">
    ...
    <div class="cbp-item web-design motion">
        <a href="{{ asset('assets/global/img/portfolio/1200x900/8.jpg') }}" class="cbp-caption cbp-lightbox" data-title="Remind~Me Widget<br>by Tiberiu Neamu">
            <div class="cbp-caption-defaultWrap">
    ...
    <div class="cbp-item identity">
        <a href="{{ asset('assets/global/img/portfolio/1200x900/09.jpg') }}" class="cbp-caption cbp-lightbox" data-title="Smart Searchy<br>by Tiberiu Neamu">
            <div class="cbp-caption-defaultWrap">
                <img src="{{ asset('assets/global/img/portfolio/600x600/35.jpg') }}" alt="">
            </div>
            <div class="cbp-caption-activeWrap">
                <div class="cbp-l-caption-alignLeft">
                    <div class="cbp-l-caption-body">
    ...
    <div class="cbp-item web-design">
        <a href="{{ asset('assets/global/img/portfolio/1200x900/9.jpg') }}" class="cbp-caption cbp-lightbox" data-title="Workout Buddy<br>by Tiberiu Neamu">
            <div class="cbp-caption-defaultWrap">
                <img src="{{ asset('assets/global/img/portfolio/600x600/36.jpg') }}" alt="">
            </div>
            <div class="cbp-caption-activeWrap">
                <div class="cbp-l-caption-alignLeft">
                    <div class="cbp-l-caption-body">
...
<div class="cbp-loadMore-block2">
    ...
    <div class="cbp-item web-design logos">
        <a href="{{ asset('assets/global/img/portfolio/1200x900/16.jpg') }}" class="cbp-caption cbp-lightbox" data-title="Timezone Mgmt<br>by Cosmin Capitanu">
            <div class="cbp-caption-defaultWrap">
                <img src="{{ asset('assets/global/img/portfolio/600x600/42.jpg') }}" alt="">
            </div>
            <div class="cbp-caption-activeWrap">
                <div class="cbp-l-caption-alignLeft">
                    <div class="cbp-l-caption-body">
    ...
    <div class="cbp-item identity">
        <a href="{{ asset('assets/global/img/portfolio/1200x900/17.jpg') }}" class="cbp-caption cbp-lightbox" data-title="Holiday Selector<br>by Cosmin Capitanu">
            <div class="cbp-caption-defaultWrap">
                <img src="{{ asset('assets/global/img/portfolio/600x600/43.jpg') }}" alt="">
            </div>
            <div class="cbp-caption-activeWrap">
                <div class="cbp-l-caption-alignLeft">
                    <div class="cbp-l-caption-body">
    ...
    <div class="cbp-item graphic motion">
        <a href="{{ asset('assets/global/img/portfolio/1200x900/18.jpg') }}" class="cbp-caption cbp-lightbox" data-title="Augmented Tourist<br>by Cosmin Capitanu">
            <div class="cbp-caption-defaultWrap">
                <img src="{{ asset('assets/global/img/portfolio/600x600/44.jpg') }}" alt="">
            </div>
            <div class="cbp-caption-activeWrap">
                <div class="cbp-l-caption-alignLeft">
                    <div class="cbp-l-caption-body">
    ...
    <div class="cbp-item logos motion">
        <a href="{{ asset('assets/global/img/portfolio/1200x900/19.jpg') }}" class="cbp-caption cbp-lightbox" data-title="Bills Bills Bills<br>by Cosmin Capitanu">
            <div class="cbp-caption-defaultWrap">
...
<div class="cbp-loadMore-block3">
    ...
    <div class="cbp-item web-design">
        <a href="{{ asset('assets/global/img/portfolio/1200x900/24.jpg') }}" class="cbp-caption cbp-lightbox" data-title="Flat Roman Typeface Ui<br>by Cosmin Capitanu">
            <div class="cbp-caption-defaultWrap">
                <img src="{{ asset('assets/global/img/portfolio/1200x900/24.jpg') }}" alt="">
            </div>
            <div class="cbp-caption-activeWrap">
                <div class="cbp-l-caption-alignLeft">
                    <div class="cbp-l-caption-body">
    ...
    <div class="cbp-item graphic motion">
        <a href="{{ asset('assets/global/img/portfolio/1200x900/25.jpg') }}" class="cbp-caption cbp-lightbox" data-title="Easy Note<br>by Cosmin Capitanu">
            <div class="cbp-caption-defaultWrap">
                <img src="{{ asset('assets/global/img/portfolio/600x600/50.jpg') }}" alt="">
            </div>
            <div class="cbp-caption-activeWrap">
                <div class="cbp-l-caption-alignLeft">
                    <div class="cbp-l-caption-body">
    ...
    <div class="cbp-item web-design">
        <a href="{{ asset('assets/global/img/portfolio/1200x900/26.jpg') }}" class="cbp-caption cbp-lightbox" data-title="Student Guide<br>by Cosmin Capitanu">
            <div class="cbp-caption-defaultWrap">
                <img src="{{ asset('assets/global/img/portfolio/600x600/51.jpg') }}" alt="">
            </div>
            <div class="cbp-caption-activeWrap">
                <div class="cbp-l-caption-alignLeft">
                    <div class="cbp-l-caption-body">
    ...
    <div class="cbp-item graphic">
        <a href="{{ asset('assets/global/img/portfolio/1200x900/27.jpg') }}" class="cbp-caption cbp-lightbox" data-title="Geo Tagging<br>by Cosmin Capitanu">
            <div class="cbp-caption-defaultWrap">
                <img src="{{ asset('assets/global/img/portfolio/1200x900/52.jpg') }}" alt="">
            </div>
            <div class="cbp-caption-activeWrap">
                <div class="cbp-l-caption-alignLeft">
                    <div class="cbp-l-caption-body">
