<div class="portfolio-content">
    <div class="cbp-l-project-title">World Clock Widget</div>
        ...
        <ul class="cbp-slider-wrap">
            <li class="cbp-slider-item">
                <a href="{{ asset('assets/global/img/portfolio/1200x900/13.jpg') }}" class="cbp-lightbox">
                    <img src="{{ asset('assets/global/img/portfolio/1200x900/13.jpg') }}" alt=""> </a>
            </li>
            <li class="cbp-slider-item">
                <a href="{{ asset('assets/global/img/portfolio/1200x900/14.jpg') }}" class="cbp-lightbox">
                    <img src="{{ asset('assets/global/img/portfolio/1200x900/14.jpg') }}" alt=""> </a>
            </li>
            <li class="cbp-slider-item">
                <a href="{{ asset('assets/global/img/portfolio/1200x900/01.jpg') }}" class="cbp-lightbox">
                    <img src="{{ asset('assets/global/img/portfolio/1200x900/01.jpg') }}" alt=""> </a>
            </li>
        </ul>
    </div>
