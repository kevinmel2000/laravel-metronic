...
<html lang="en">
    ...
    <head>
        ...
        <title>{{ config('app.name', 'Laravel') }} | Admin-1 | Coming Soon</title>
    ...
    <body class="">
        ...
        <!-- BEGIN PAGE LEVEL PLUGINS -->
        <script type="text/javascript" src="{{ asset('assets/global/plugins/countdown/jquery.countdown.min.js') }}"></script>
