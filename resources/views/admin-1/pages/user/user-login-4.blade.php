...
<html lang="en">
    ...
    <head>
        ...
        <title>{{ config('app.name', 'Laravel') }} | Admin-1 | User Login #4</title>
    ...
    <body class=" login">
        ...
        {{-- <script type="text/javascript" src="{{ asset('assets/pages/scripts/login-4.min.js') }}"></script> --}}
        <script type="text/javascript" src="{{ mix('js/login-4.min.js') }}"></script>
